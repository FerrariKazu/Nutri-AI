...
import { Send, Loader2, ChefHat, Sparkles, Database, Search, Beaker, ChevronDown, ChevronRight, BrainCircuit } from 'lucide-react';
                            ...
                            {steps.map((step, idx) => (
                                <div key={idx} className="text-sm">
                                    <div className="flex items-center gap-2 mb-1">
                                        {step.stage === 'chemistry' && <Beaker className="w-3 h-3 text-blue-500" />}
