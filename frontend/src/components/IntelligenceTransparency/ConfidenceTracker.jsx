        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-bold text-blue-500 uppercase tracking-widest font-mono">
                        Server Asserted
                    </span>
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between group">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-neutral-400 uppercase font-black">Baseline Evidence</span>
                    </div>
                ...
                {breakdown.multipliers && breakdown.multipliers.length > 0 ? (
                    ...
                    <div className="flex items-center justify-between pl-4 border-l border-neutral-800">
                        <div className="flex items-center gap-2">
                            <Plus className="w-3 h-3 text-green-500/50" />
                            <span className="text-[10px] text-neutral-500 uppercase">Universal Verification</span>
                        </div>
                ...
                {Math.abs(breakdown.policy_adjustment) > 0 && (
                    <div className="flex items-center justify-between pl-4 border-l border-neutral-800">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] text-neutral-500 uppercase">Policy Normalization</span>
                        </div>
                ...
                <div className="pt-4 border-t border-neutral-800 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[9px] text-neutral-500 font-black uppercase tracking-widest">Final Belief</span>
                    ...
                    {expertMode && (
                        <div className="text-[9px] font-mono text-neutral-600 bg-neutral-800/40 px-2 py-1 rounded">
                            SSOT Asserted
                        </div>
                    )}
                </div>
