...
const ReasoningConsole = ({ onSend, isLoading, isMemoryActive, setInputValue: externalSetInputValue }) => {
    ...
    return (
        <div className="p-3 md:p-6 bg-neutral-950/80 border-t border-neutral-800 backdrop-blur-none safe-bottom" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
            <div className="max-w-4xl mx-auto flex flex-col gap-2 md:gap-3">
                ...
                {/* Input Surface */}
                <div className="flex items-center gap-2 w-full bg-neutral-900 border border-neutral-800 rounded-lg px-2 py-1 group focus-within:border-neutral-600 transition-all">
                    <div className="flex items-center pointer-events-none pl-2 shrink-0">
                    ...
                    <textarea
                        ...
                        rows={1}
                        className={`flex-1 min-w-0 bg-transparent min-h-[44px] max-h-[200px] overflow-y-auto overflow-x-hidden text-sm md:text-base font-sans focus:outline-none placeholder:text-neutral-600 resize-none leading-relaxed py-3 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    />
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                        ...
                        <button
                            ...
                            className={`
                                shrink-0 w-10 h-10 flex items-center justify-center rounded-md transition-all active:scale-95
